...
> **Boilerplate status:** Required when the project uses an agent framework (LangGraph, CrewAI, AutoGen, multi-agent orchestration, etc.). Filled in by the tech-architect sub-agent as part of the tech design stage.
>
